...
RESOURCES += src/qt/ussc.qrc src/qt/ussc_locale.qrc

TRANSLATIONS += src/qt/locale/ussc_bg.ts \
                src/qt/locale/ussc_de.ts \
                src/qt/locale/ussc_en.ts \
                src/qt/locale/ussc_es.ts \
                src/qt/locale/ussc_fi.ts \
                src/qt/locale/ussc_fr.ts \
                src/qt/locale/ussc_it.ts \
                src/qt/locale/ussc_ja.ts \
                src/qt/locale/ussc_pl.ts \
                src/qt/locale/ussc_pt.ts \
                src/qt/locale/ussc_ru.ts \
                src/qt/locale/ussc_sk.ts \
                src/qt/locale/ussc_sv.ts \
                src/qt/locale/ussc_vi.ts \
                src/qt/locale/ussc_zh_CN.ts \
                src/qt/locale/ussc_zh_TW.ts
