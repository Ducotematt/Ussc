...
#define MyAppName "UssCoin Core"
#define MyAppPublisher "2021 USSCOIN Core Developers"
#define MyAppURL "https://usscsset.io"
#define MyAppExeName "ussc-qt.exe"
#define MyAppExtraData "https://explorer.decenomy.net/bootstraps/USSC/bootstrap.zip"
...
OutputDir=.\output
OutputBaseFilename=UssCoinSetup
...
[Files]
Source: ".\package\ussc-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\UssCoin\UssCoin-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\UssCoin\UssCoin-Qt,strDataDir|{userappdata}\UssCoin\}');
  Result := True;
end;
