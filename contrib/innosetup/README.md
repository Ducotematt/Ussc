...
* Fill in the following data:
    * Application Name: `UssCoin Core`
    * Application Version: `1.2.0.0`
    * Application Publisher: `2020 UssCoin Core Developers`
    * Application Website: `https://usscsset.io/`
* Setup the destination folder:
    * Program Files Folder
    * Folder name: `UssCoin`
* Add application files:
    * Select the file `ussc-pt.exe` as main executable from the `package` folder
...
* Compiler settings
    ...
    * Edit the output base filename to: `ussc-1.1.0-win64-setup.exe`
