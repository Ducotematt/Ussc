...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='usscoin.conf'
CONFIGFOLDER='/root/.usscoin'
COIN_DAEMON='usscd'
COIN_CLI='ussc-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ=`curl -s https://api.github.com/repos/usscoin-com/USSC/releases/latest | grep "browser_download_url.*Linux\\.zip" | cut -d : -f 2,3 | tr -d \" | xargs`
