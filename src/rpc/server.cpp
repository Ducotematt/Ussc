...
UniValue stop(const JSONRPCRequest& jsonRequest)
{
    ...
    StartShutdown();
    return "UssCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* USSC features */
        {"usscoin", "listmasternodes", &listmasternodes, true },
        {"usscoin", "getmasternodecount", &getmasternodecount, true },
        {"usscoin", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"usscoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"usscoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"usscoin", "masternodecurrent", &masternodecurrent, true },
        {"usscoin", "startmasternode", &startmasternode, true },
        {"usscoin", "createmasternodekey", &createmasternodekey, true },
        {"usscoin", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"usscoin", "listmasternodeconf", &listmasternodeconf, true },
        {"usscoin", "getmasternodestatus", &getmasternodestatus, true },
        {"usscoin", "getmasternodewinners", &getmasternodewinners, true },
        {"usscoin", "getmasternodescores", &getmasternodescores, true },
        {"usscoin", "preparebudget", &preparebudget, true },
        {"usscoin", "submitbudget", &submitbudget, true },
        {"usscoin", "mnbudgetvote", &mnbudgetvote, true },
        {"usscoin", "getbudgetvotes", &getbudgetvotes, true },
        {"usscoin", "getnextsuperblock", &getnextsuperblock, true },
        {"usscoin", "getbudgetprojection", &getbudgetprojection, true },
        {"usscoin", "getbudgetinfo", &getbudgetinfo, true },
        {"usscoin", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"usscoin", "mnfinalbudget", &mnfinalbudget, true },
        {"usscoin", "checkbudgets", &checkbudgets, true },
        {"usscoin", "mnsync", &mnsync, true },
        {"usscoin", "spork", &spork, true },
        ...
        {"zerocoin", "getzusscseed", &getzusscseed, false },
        {"zerocoin", "setzusscseed", &setzusscseed, false },
        {"zerocoin", "generatemintlist", &generatemintlist, false },
        {"zerocoin", "searchdzussc", &searchdzussc, false },
        {"zerocoin", "dzusscstate", &dzusscstate, false },
...
{
    return "> ussc-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:8339/\n";
}
