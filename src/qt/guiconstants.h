...
/* UssCoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "UssCoin"
#define QAPP_ORG_DOMAIN "usscoin.org"
#define QAPP_APP_NAME_DEFAULT "UssCoin-Qt"
#define QAPP_APP_NAME_TESTNET "UssCoin-Qt-testnet"
