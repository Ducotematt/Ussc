...
#include "qt/ussc/forms/ui_addresseswidget.h"
#include "qt/ussc/addresslabelrow.h"
#include "qt/ussc/addnewaddressdialog.h"
#include "qt/ussc/tooltipmenu.h"
...
void AddressesWidget::onStoreContactClicked()
{
    if (walletModel) {
        ...
        CTxDestination usscAdd = DecodeDestination(address.toUtf8().constData());
        ...
        if (walletModel->updateAddressBookLabels(
            usscAdd, label.toUtf8().constData(),AddressBook::AddressBookPurpose::SEND
        )) {
