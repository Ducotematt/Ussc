...
#include "qt/ussc/send.h"
#include "qt/ussc/forms/ui_send.h"
#include "qt/ussc/addnewcontactdialog.h"
#include "qt/ussc/qtutils.h"
#include "qt/ussc/sendchangeaddressdialog.h"
#include "qt/ussc/optionbutton.h"
#include "qt/ussc/sendconfirmdialog.h"
#include "qt/ussc/myaddressrow.h"
#include "qt/ussc/guitransactionsutils.h"
    ...
    btnContacts(new QPushButton())
{
    ...
    setCssProperty(coinIcon, "coin-icon-ussc");
...
void SendWidget::onContactMultiClicked()
{
    if (focusedEntry) {
        ...
        CTxDestination usscAdd = DecodeDestination(address.toStdString());
        if (walletModel->isMine(usscAdd)) {
        ...
        if (dialog->res) {
            ...
            if (walletModel->updateAddressBookLabels(usscAdd, dialog->getLabel().toStdString(),
                    AddressBook::AddressBookPurpose::SEND)) {
