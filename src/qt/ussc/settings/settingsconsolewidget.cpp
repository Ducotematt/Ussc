...
#include "qt/ussc/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/ussc/settings/moc_settingsconsolewidget.cpp"
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
    ...
    message(CMD_REPLY, (tr("Welcome to the USSC RPC console.") + "<br>" +
