...
#include "qt/ussc/forms/ui_topbar.h"
#include "qt/ussc/loadingdialog.h"
#include "qt/ussc/lockunlock.h"
#include "qt/ussc/qtutils.h"
#include "qt/ussc/receivedialog.h"
                                                        ...
                                                        ui(new Ui::TopBar)
{
    ...
    ui->pushButtonConf->setButtonText("usscoin.conf");
...
void TopBar::onBtnConfClicked()
{
    ...
    if (!GUIUtil::openConfigfile())
        inform(tr("Unable to open usscoin.conf with default application"));
}
