...
#error Client version information missing: version is not defined by ussc-config.h or in any other way
#endif
...
/**
 * usscd-res.rc includes this file, but it cannot cope with real c++ code.
