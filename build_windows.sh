...
# Create zip file of binaries
	cp src/usscd.exe src/ussc-cli.exe src/ussc-tx.exe src/qt/ussc-qt.exe .
	zip USSC-Windows.zip usscd.exe ussc-cli.exe ussc-tx.exe ussc-qt.exe
	rm -f usscd.exe ussc-cli.exe ussc-tx.exe ussc-qt.exe
	make clean
