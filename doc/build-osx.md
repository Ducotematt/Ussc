...
1. Clone the PIVX Core source code:
        ...
        git clone https://github.com/ussc-project/ussc
        cd ussc
...
PIVX Core is now available at `./src/usscd`

Before running, you may create an empty configuration file:

    mkdir -p "/Users/${USER}/Library/Application Support/PIVX"

    touch "/Users/${USER}/Library/Application Support/PIVX/ussc.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/PIVX/ussc.conf"

The first time you run usscd, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.
...
-------
    ...
    ./src/usscd -daemon # Starts the ussc daemon.
    ./src/ussc-cli --help # Outputs a list of command-line options.
    ./src/ussc-cli help # Outputs a list of RPC commands when the daemon is running.
