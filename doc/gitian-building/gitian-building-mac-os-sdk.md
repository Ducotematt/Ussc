...
The script [extract-osx-sdk.sh](https://github.com/ussc-project/ussc/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
ussc/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/ussc-project/ussc/blob/master/doc/README_osx.md) for troubleshooting tips.