...
This will build ussc-qt as well, if the dependencies are met.
...
These dependencies are required:
 ...
 libsodium   | Usscling Crypto     | A modern, portable, easy to use crypto library
 ...
 **For Ubuntu only:** db4.8 packages are available [here](https://launchpad.net/~ussc/+archive/ussc).
 You can add the repository using the following command:

    sudo apt-get install software-properties-common
    sudo add-apt-repository ppa:ussc/ussc
    sudo apt-get update
...
If you want to build ussc-qt, make sure that the required packages for Qt development
...
Once these are installed, they will be found by configure and a ussc-qt executable will be
built by default.
...
Notes
-----
The release is built with GCC and then "strip usscd" to strip the debug
