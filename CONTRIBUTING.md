Contributing to UssCoin Core
============================

The UssCoin Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/ussc-project/ussc/blob/master/doc/translation_process.md)
...
The following applies to code changes to the UssCoin Core project, and is not to be
confused with overall UssCoin Network Protocol consensus changes.

Whether a pull request is merged into UssCoin Core rests with the project merge
...
Patches that change UssCoin consensus rules are considerably more involved than
...
Where a patchset proposes to change the UssCoin consensus, it must have been
...
The project leader is the release manager for each UssCoin Core release.
