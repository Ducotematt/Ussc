...
"""Verify that starting usscoin with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start usscoin with -? for help text")
        ...
        self.log.info("Start usscoin with -version for version information")
